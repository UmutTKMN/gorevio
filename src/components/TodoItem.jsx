      ...
      >
        {isEditing ? (
          <div className="flex items-center gap-2">
            <input
              type="text"
              className={`flex-grow p-2 rounded border focus:outline-none focus:ring-2 focus:ring-blue-400 ${
                darkMode
          ...
          <>
            ...
            {showDetails && (
              <div
                className={`mt-4 pl-8 transition-colors duration-300 ${
